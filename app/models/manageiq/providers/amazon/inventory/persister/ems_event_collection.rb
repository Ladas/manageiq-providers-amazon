...
class ManageIQ::Providers::Amazon::Inventory::Persister::EmsEventCollection < ManageIQ::Providers::Amazon::Inventory::Persister
  #### code from a target, hsa to be moved
